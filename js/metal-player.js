...
const songs = ['Master of Puppets', 'Bulls On Parade', 'Wasted Years', 'Tornado of Souls', 'Iron Man', 'South Of Heaven']

const artistas = ['Metallica', 'Rage Against The Machine', 'Iron Maiden', 'Iron Maiden', 'Black Sabbath', 'Slayer']
